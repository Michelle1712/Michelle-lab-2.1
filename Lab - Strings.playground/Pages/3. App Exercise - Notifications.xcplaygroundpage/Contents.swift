...
let lastName: String = " Nightshade"
let fullName: String = firstName + lastName; print(fullName)
/*:
...
let newBest = 15125
let congratulations: String = "Congratulations, " + fullName + "! You beat your daily high score of \(previousBest) by walking \(newBest) steps yesterday!"
